...
model.load_state_dict(torch.load('./save/EfficientNet/train_best.pth'))
...
for epoch in range(num_epochs):
    ...
    if np.mean(train_losses) < best_train_loss:
        ...
        torch.save(model.state_dict(), f'./save/EfficientNet/train_best_extend.pth')